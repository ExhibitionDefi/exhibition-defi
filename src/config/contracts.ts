...
export const CONTRACT_ADDRESSES = { 
  ...
  LP_TOKENS: import.meta.env.VITE_LP_TOKENS_ADDRESS as `0x${string}`, 
...
// Contract Addresses
export const EXHIBITION_ADDRESS = import.meta.env.VITE_EXHIBITION_ADDRESS as `0x${string}`
export const FACTORY_ADDRESS = import.meta.env.VITE_FACTORY_ADDRESS as `0x${string}`
export const LP_TOKENS_ADDRESS = import.meta.env.VITE_LP_TOKENS_ADDRESS as `0x${string}`
export const AMM_ADDRESS = import.meta.env.VITE_AMM_ADDRESS as `0x${string}`
export const EXH_ADDRESS = import.meta.env.VITE_EXH_ADDRESS as `0x${string}`
export const EXUSDT_ADDRESS = import.meta.env.VITE_EXUSDT_ADDRESS as `0x${string}`
export const EXNEX_ADDRESS = import.meta.env.VITE_EXNEX_ADDRESS as `0x${string}`
