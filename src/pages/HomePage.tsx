    ...
    <div className="space-y-12">
      ...
      <section className="text-center space-y-6">
        ...
        <p className="text-xl text-[var(--metallic-silver)] max-w-3xl mx-auto">
          The most advanced decentralized launchpad on Nexus. Create, fund, and launch your token 
          with built-in liquidity, vesting, and community governance.
        </p>
      ...
      <section className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="text-center hover:border-[var(--neon-blue)]/30 transition-all duration-300" hover>
            ...
            <h3 className="text-xl font-semibold text-[var(--silver-light)] mb-2">Secure & Audited</h3>
            <p className="text-[var(--metallic-silver)]">
              Smart contracts built with security-first principles and comprehensive testing
            </p>
          </Card>

          <Card className="text-center hover:border-[var(--neon-orange)]/30 transition-all duration-300" hover>
            <Zap className="h-12 w-12 text-[var(--neon-orange)] mx-auto mb-4 drop-shadow-[0_0_8px_var(--neon-orange)]" />
            <h3 className="text-xl font-semibold text-[var(--silver-light)] mb-2">Instant Liquidity</h3>
            <p className="text-[var(--metallic-silver)]">
              Automatic AMM liquidity provision with configurable lock periods
            </p>
          </Card>

          <Card className="text-center hover:border-[var(--neon-blue)]/30 transition-all duration-300" hover>
            <TrendingUp className="h-12 w-12 text-[var(--neon-blue)] mx-auto mb-4 drop-shadow-[0_0_8px_var(--neon-blue)]" />
            <h3 className="text-xl font-semibold text-[var(--silver-light)] mb-2">Fair Launch</h3>
            <p className="text-[var(--metallic-silver)]">
              Transparent pricing, vesting schedules, and community-driven funding
            </p>
          </Card>
        </div>
      </section>
