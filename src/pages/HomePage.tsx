    ...
    <div className="space-y-12">
      ...
      <section className="text-center space-y-6">
        ...
        <p className="text-xl text-[var(--metallic-silver)] max-w-3xl mx-auto">
          Exhibition replaces discretionary market makers with contract-enforced liquidity.
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-6xl mx-auto">
          <Card className="text-center hover:border-[var(--neon-blue)]/30 transition-colors duration-300" hover>
            <div className="space-y-2">
              ...
              <p className="text-sm text-[var(--metallic-silver)]">Total Launches</p>
            </div>
          </Card>
          ...
          <Card className="text-center hover:border-[var(--neon-orange)]/30 transition-colors duration-300" hover>
            <div className="space-y-2">
              ...
              <p className="text-sm text-[var(--metallic-silver)]">Active Launches</p>
            </div>
          </Card>
          ...
          <Card className="text-center hover:border-[var(--neon-orange)]/30 transition-colors duration-300" hover>
            <div className="space-y-2">
              ...
              <p className="text-2xl font-bold text-[var(--silver-light)]">
      ...
      <section className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <Card className="text-center hover:border-[var(--neon-orange)]/30 transition-all duration-300" hover>
            ...
            <h3 className="text-xl font-semibold text-[var(--silver-light)] mb-2">Deterministic Market Initialization</h3>
            <p className="text-[var(--metallic-silver)]">
          ...
          <Card className="text-center hover:border-[var(--neon-blue)]/30 transition-all duration-300" hover>
            ...
            <h3 className="text-xl font-semibold text-[var(--silver-light)] mb-2">Liquidity Bootstrapping</h3>
            <p className="text-[var(--metallic-silver)]">
          ...
          <Card className="text-center hover:border-[var(--neon-orange)]/30 transition-all duration-300" hover>
            ...
            <h3 className="text-xl font-semibold text-[var(--silver-light)] mb-2">Native to Nexus Layer 1</h3>
            <p className="text-[var(--metallic-silver)]">
