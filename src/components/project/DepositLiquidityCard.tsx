  ...
  const handleInputChange = (value: string) => {
    ...
    try {
      ...
      if (amount <= BigInt(0)) {
        ...
        setInputError(`Amount exceeds remaining required (${liquidityInfo.formattedRemaining} ${tokenSymbol})`)
      }
    } catch {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-[var(--silver-light)]">
              Deposit {tokenSymbol} for AMM pool creation
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 pt-2">
          <div className="text-center">
            ...
            <p className="text-sm font-medium text-[var(--off-white)]">
              {parseFloat(liquidityInfo.formattedRequired).toLocaleString(undefined, {
          ...
          <div className="text-center">
            ...
            <p className="text-sm font-medium text-[var(--neon-blue)]">
              {parseFloat(liquidityInfo.formattedDeposited).toLocaleString(undefined, {
                maximumFractionDigits: 2,
              })}
            </p>
            <p className="text-xs text-[var(--silver-dark)]">{tokenSymbol}</p>
          ...
          <div className="text-center">
            ...
            <p className="text-sm font-medium text-[var(--neon-orange)]">
              {parseFloat(liquidityInfo.formattedRemaining).toLocaleString(undefined, {
                maximumFractionDigits: 2,
              })}
            </p>
            <p className="text-xs text-[var(--silver-dark)]">{tokenSymbol}</p>
