...
export const Layout: React.FC<LayoutProps> = ({ 
  ...
  const customMessage = "Welcome to Exhibition, a verifiable token launchpad integrated with DEX and dedicated lock, built on Nexus verifiable network for the AI era."
